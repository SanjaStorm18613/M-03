...
@Autonomous(name = "HEIGTH_RIGHT", group = "LinearOpMode")
public class HEIGTH_RIGHT extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        ArrayList<Pair<Double, Integer>> steps = cAuto.getHeightSteps(parkArea, 1.0);
        ArrayList<Boolean> drSide = cAuto.getHightDRSide();
